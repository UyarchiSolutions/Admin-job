...
@Component({
  selector: 'app-new-test-cand',
  templateUrl: './new-test-cand.component.html',
  styleUrls: ['./new-test-cand.component.css'],
})
export class NewTestCandComponent {
  ...
  getTestUsers() {
    this.api
      .getTestUsersNew(this.filterForm.value.key, this.filterForm.value.action)
      .subscribe((e: any) => {
        this.users = e.values;
        this.cand2 = e.values;
